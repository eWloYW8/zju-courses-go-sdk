...
type Exam struct {
	...
	Mode                   string `json:"mode,omitempty"` // "exam" or "practice"
	...
	LimitAnswerOnSingleClient  bool    `json:"limit_answer_on_signle_client,omitempty"` // note: typo in API

	// EZTest integration
	Platform string      `json:"platform,omitempty"` // "tronclass" or "eztest"
	EZTest   interface{} `json:"eztest,omitempty"`

	// Options
	DefaultOptionsLayout string `json:"default_options_layout,omitempty"`
	SubjectIndexType     string `json:"subject_index_type,omitempty"` // "group"
	...
	MakeUpRecord    interface{}   `json:"make_up_record,omitempty"`
	ExamSubmissions []interface{} `json:"exam_submissions,omitempty"`
	SubjectsCount   int           `json:"subjects_count,omitempty"`

	// Data (nested config, varies by exam type)
...
// ExamScore represents an exam score entry.
...
type ExamSubject struct {
	...
	Type              string           `json:"type"` // single_selection, multiple_selection, true_or_false, short_answer, fill_in_blank, matching, cloze, analysis, media, text, paragraph_desc, random
	Description       string           `json:"description,omitempty"`
	Point             interface{}      `json:"point,omitempty"` // string or number
	Score             interface{}      `json:"score,omitempty"`
	Sort              int              `json:"sort,omitempty"`
	ParentID          *int             `json:"parent_id,omitempty"`
	GroupID           *int             `json:"group_id,omitempty"`
	DifficultyLevel   string           `json:"difficulty_level,omitempty"` // "none", "medium"
	...
	OptionsLayout     string           `json:"options_layout,omitempty"` // "vertical"
	OptionType        string           `json:"option_type,omitempty"`   // "text"
	ScoreRule         string           `json:"score_rule,omitempty"`    // "single"
