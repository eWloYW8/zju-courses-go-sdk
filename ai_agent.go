...
// AI Agent/Chatbot related methods are added to AirCreditService.

// --- AI Agent ---

// GetRecentAIAgentCourses returns recent courses for the AI agent.
func (s *AirCreditService) GetRecentAIAgentCourses(ctx context.Context) (json.RawMessage, error) {
...
func (s *AirCreditService) GetRecentAIConversations(ctx context.Context) (json.RawMessage, error) {
	var result json.RawMessage
...
func (s *AirCreditService) GetCourseChatUsageInfo(ctx context.Context, courseID int) (json.RawMessage, error) {
...
func (s *AirCreditService) GetCourseCreditToken(ctx context.Context, courseID int) (json.RawMessage, error) {
...
func (s *AirCreditService) UploadAIScreenShot(ctx context.Context, body interface{}) (json.RawMessage, error) {
	var result json.RawMessage
...
func (s *AirCreditService) CheckKnowledgeNodesExist(ctx context.Context, courseID int) (json.RawMessage, error) {
...
func (s *AirCreditService) SyncKnowledgeNodesWithAI(ctx context.Context, courseID int) (json.RawMessage, error) {
...
func (s *AirCreditService) GetKnowledgeGraphSettings(ctx context.Context, graphID int) (json.RawMessage, error) {
...
func (s *AirCreditService) GetCurrentSemesterCourses(ctx context.Context) (json.RawMessage, error) {
	var result json.RawMessage
